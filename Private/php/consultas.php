    ...
    class Consultas {
        ...
        public function readMore($curso) {
            ...
            $query = 'SELECT tb_aluno.nome, tb_aluno.documento, 
                            ...
                            tb_empresa.numero as numero_empresa,
                            tb_empresa.complemento as complemento_empresa,
                            tb_empresa.bairro as bairro_empresa,
                            tb_empresa.cidade as cidade_empresa,
                            tb_empresa.estado as estado_empresa,
                            tb_empresa.cep as cep_empresa,
